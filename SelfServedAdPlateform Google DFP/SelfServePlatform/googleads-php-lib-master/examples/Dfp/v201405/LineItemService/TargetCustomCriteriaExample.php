...
try {
  ...
  $lineItemId = '111685250';
  $customCriteriaIds1 = array('208010',
      '127073485730');
  $customCriteriaIds2 = array('207530',
      '127073558450');
  $customCriteriaIds3 = array('208130',
      '125138143730');
  ...
  $statementBuilder->Where('id = :id')
      ->OrderBy('id ASC')
      ->Limit(1)
      ->WithBindVariableValue($lineItemId,'125138143730' );
